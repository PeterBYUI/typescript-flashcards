...
export default function Flashcard({ flashcard }: FlashcardComponentProps) {
    ...
    return <div className="flex gap-4">
        <div className="flex flex-col w-1/1">
            ...
            <Input styling="w-1/1" value={card?.question || ""} />
        </div>
        <div className="flex flex-col w-1/1">
            <label className="text-[rgba(100,190,171)] font-semibold">Answer</label>
            <Input styling="w-1/1" value={card?.answer || ""} />
        </div>
        <Button styling="translate-y-[20%] hover:text-red-400"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
